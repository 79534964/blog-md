...
例：
There was an enthusiastic ** response ** to my suggestions. * 我的提议得到了热情的响应 *
...
例：
to ** debate ** buying a new car. * 思量是否买辆新汽车 *
But had Entergy kept its word,that ** debate ** would be beside the point. * 但是如果安特吉公司遵守诺言，那么这场政变就无关紧要了 *
This ** debate ** makes no sense. * 这场争论无意义 *

## interaction
名：相互作用；相互影响；互动交流
扩：
inter (表达 在...之间，相互) + action (行动) = interation (相互作用)

There is ** interaction ** between teaching and learning. * 教与学是互动的 *
** interaction ** interaction among students and teachers. * 师生之间的相互交流 *
The ** interaction ** of the two groups produced many good ideas. * 两个小组的互动交流产生了许多好生意 *

## interact
动：相互作用 相互影响
扩：
interaction 相互影响的 interaction with 交往 social interaction 社会互动 intermittent 间断的 mutual 相互的

例：
Parthers must ** interact ** with each other's ideas. * 合作伙伴必须相互交流想法 *
** interaction ** with * 交流  与什么什么相互影响 *
Teachers should ** interact ** more with students. * 老师应该与学生有更多的互动 *

## interactivity
名：交互性 互动性
扩：
inter 相互 activity 加在一起 "互动"

例：
A site selling the right kind of products with the right mix of ** interactivity **, hospitality, and security will attract custmoers. * 一个网站销售合适的产品，并将交互性 礼貌周到 安全性正确的结合起来就会吸引客户 *
teaching ** interactivity **. * 教学互动 *
fast ** interactivity ** with information. * 快速信息交互 *
...
例：
the ** conservation ** of water. * 保护水资源 *
wildlife ** consercation ** * 野生动物保护 *
decreasing oil consumption through ** conservation **. * 通过节约以减少原油消耗 *
...
例：
We welcome ** feedback ** from our readers. * 我们欢迎来自读者的反馈 *
The teacher will give you ** feedback ** on the test. * 老师回对你的测试提交提供反馈信息 *
** feedback ** from the consumer. * 来自消费者的反馈 *
